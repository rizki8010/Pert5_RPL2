package com.mycompany.pert5_51422467.controller;

import com.mycompany.pert5_51422467.model.ModelMahasiswa;
import com.mycompany.pert5_51422467.repository.MahasiswaRepository;
...
public class MahasiswaController {
    ...
    public void tampilkanMenu() {
        ...
        do {
            ...
            switch (opsi) {
                case 1 -> tampilkanSemuaMahasiswa();
                case 2 -> tambahMahasiswa(scanner);
                case 3 -> cekKoneksi();
